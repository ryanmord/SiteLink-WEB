...
class Approveduser extends Mailable
{
    ...
    {
        $introLines = array('Your associate approval request for'.config('app.name').' app is approved successfully');
        ...
        $subject = config('app.name').': Asscociate Request Approved Successfully';
