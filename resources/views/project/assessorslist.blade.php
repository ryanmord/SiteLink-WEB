  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">Assign New Assessor</h4>
      ...
      <br>
      <input type="text" name="search-user" id="search-user" placeholder="  Seach by name" style="border-width: 1px 1px 1px 1px;width: 100%; height: 30px;"><br><br>
       <input type="hidden" name="associate-ids" id="associate-ids" value=" ">
       <input type="hidden" name="assign_project_id" id="assign_project_id">
      ...
      <div class="table-responsive" id="associatetable" style="max-height: 400px;overflow-y: scroll;">
        ...
        <table class="table table-bordered table-hover table-striped">
          <thead>
            ...
            <br><br>
           <center>
              <button type="button" data-dismiss="modal" id="assign-user" class="btn red-btn">Assign</button>&nbsp &nbsp 
                &nbsp &nbsp
                <button type="button" data-dismiss="modal" id="cancel-user" class="btn red-btn">Cancel</button>  <br><br>
            </center>
            </div>
            <div id="no_any_user">
