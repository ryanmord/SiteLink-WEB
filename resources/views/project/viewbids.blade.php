                                        ...
                                        <td class="table-td-th">
                                            <div class="btn-group">
                                                ...
                                                right: 100% !important;text-align: center !important;transform: translate(-75%, 0) !important;">
                                                    ...
                                                    <li><a href="{{url('/allProejcts/bid/'.$value['projectid'].'/'.$value['associateid'].'/1')}}" onclick="return confirm('Are you want to sure the accept this request?')">Accept</a></li>
                                                    <li><a href="{{url('/allProejcts/bid/'.$value['projectid'].'/'.$value['associateid'].'/0')}}" onclick="return confirm('Are you want to sure  the reject this request?')">Reject</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
