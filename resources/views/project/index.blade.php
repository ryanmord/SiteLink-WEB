            ...
            <table class="table table-bordered table-hover table-striped">
		        <thead>
                    <tr bgcolor="#EEEEEE">
                        ...
                        <th class="table-td-th" width="120" data-id="1" id="name-th" onclick="sortTable(1,'name-th','name-th-asc','name-th-desc')" style="cursor: pointer;">Name  <i class='fa fa-arrow-down fa-icon-sort' id="name-th-desc"></i><i class='fa fa-arrow-up fa-icon-sort' id="name-th-asc"></i></th>
