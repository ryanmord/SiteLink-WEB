...
<span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a>Non Allocated Projects</h3>
</div>
    	...
    	<tbody id="myTable">
            @foreach ($projects as $project)
               	<tr class="content">
                    ...
                    <a class="text-primary" href="{{url('projectBid/'.$project['projectid'])}}">
