...
<link href="<?php echo e(asset('/css/frontCss/webmap.css')); ?>" rel="stylesheet">
                            ...
                            <ul class="vertical-tabs nav nav-tabs col-md-3" id="projectlist">
                              ...
                              <?php $i = 1;?>
                                <?php $__currentLoopData = $availableProject['publishprojects']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if($i == 1): ?>
                                    <li value="<?php echo e($value['projectid']); ?>" id="<?php echo e($value['projectid']); ?>" ><a href="#history1" class ="active odd" data-toggle="tab"><?php echo e($value['projectname']); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                  <?php elseif($i %2 == 0): ?>
                                    <li value="<?php echo e($value['projectid']); ?>" id="<?php echo e($value['projectid']); ?>"><a href="#history2" class ="even" data-toggle="tab"><?php echo e($value['projectname']); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                  <?php else: ?>
                                    <li value="<?php echo e($value['projectid']); ?>" id="<?php echo e($value['projectid']); ?>"><a href="#history1" class ="odd" data-toggle="tab"><?php echo e($value['projectname']); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                  <?php endif; ?>
                                  <?php ++$i;?>
                                ...
                                <div class="project-detail"> 
                                  ...
                                  <div class="ls-project">
                                    ...
                                    <div class="ls-project-address">    
                                      <div class="ls-title">
                                        <h4 id="projectname"><?php echo e($projectdetail['projectname']); ?></h4>
                                          <span class="project-date" id="createddate"><?php echo e($projectdetail['createddate']); ?></span>
                                          <span class="project-id" id= "projectid"><?php echo e($projectdetail['projectid']); ?></span>
                                          <input type="hidden" name="project_id" id="project_id" value="<?php echo e($projectdetail['project_id']); ?>">
                                      </div> 
                                      <hr>
                                      <div class="ls-address">
                                        <div class="address">
                                          <h5><i class="fa fa-map-marker" aria-hidden="true"></i> Site Address</h5>
                                          <strong id="siteaddress"><?php echo e($projectdetail['siteaddress']); ?></strong>
                                        </div>
                                        <br><br><br>
                                        <div class="report-date" style="float: left;">
                                          <h5><i class="fa fa-calendar" aria-hidden="true"></i>Report Due From Field</h5>
                                          <strong id="reportduedate"><?php echo e($projectdetail['reportduedate']); ?></strong>
                                        </div>
                                        <div class="report-date" >
                                          <h5><i class="fa fa-calendar" aria-hidden="true"></i>On Site Date</h5>
                                          <strong id="onsitedate"><?php echo e($projectdetail['onsitedate']); ?></strong>
                                        </div>
                                        <br><br><br>
                                                     <div class="report-date" style="float: left;">
                                                          <h5>Property Type</h5>
                                                          <strong id="propertyType"><?php echo e($projectdetail['propertyType']); ?></strong>
                                                      </div>
                                        <br><br><br>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>No. Units&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>  
                                                          <strong id="noOfUnits"><?php echo e($projectdetail['noOfUnits']); ?></strong>

                                                      </div>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>Sq. Footage&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="sqFootage"><?php echo e($projectdetail['sqFootage']); ?></strong>
                                                      </div>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>No. Buildings&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="noBuildings"><?php echo e($projectdetail['noBuildings']); ?></strong>
                                                      </div>
                                                       <div class="report-date" style="float: left;">
                                                          <h5>Land Area&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="landArea"><?php echo e($projectdetail['landArea']); ?></strong>
                                                      </div>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>No. Stories&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="noOfStories"><?php echo e($projectdetail['noOfStories']); ?></strong>
                                                      </div>
                                                       <div class="report-date" style="float: left;">
                                                          <h5>Year Built&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="yearBuilt"><?php echo e($projectdetail['yearBuilt']); ?></strong>
                                                      </div>
                                      </div>
                                    </div>
                                    <!-- ls-project-address -->
                                    ...
                                    <div class="ls-scope">
                                      <h5>Scope(s)</h5>    
                                      <ul><li id="scope"><?php echo e($projectdetail['scope']); ?></li></ul> 
                                      <hr>   
                                      <h5>Report Template</h5>    
                                      <ul><li id="template"><?php echo e($projectdetail['template']); ?></li></ul>    
                                    </div>
                                                       
                                    <div class="ls-instrucation">
                                      <h5>Special Instruction</h5>
                                      <p id="instructions"><?php echo e($projectdetail['instructions']); ?></p>  
                                    </div>   
                                  ...
                                  <?php if(session('associateTypeId') != 1): ?>
                                    <div class="rs-suggest-bid">
                                      <h4>Suggest Bid</h4>
                                      <font id="approxbid"> <?php echo e($projectdetail['approxbid']); ?></font>   
                                    </div>
                                    <div class="rs-suggest-bid">
                                      <h4>Job Reach</h4>
                                        <font id="jobReach" style="font-size: 15px;">
                                          <?php echo e($projectdetail['jobReachCount']); ?>&nbsp People</font>   
                                       </div>
                                    <hr> 
                                    <?php endif; ?> 
                                     <?php if($projectdetail['associateTypeId'] == 1): ?>
                                    ...
                                    <div class="rs-make-bid">
                                      <h4>Current Bid</h4> <label id="bidstatus" style="color: #fe5f55;"><?php echo e($projectdetail['bidstatus']); ?></label><br>
                                      <label><?php echo e($projectdetail['applydate']); ?></label><br>
                                      <font id="mybid"> <?php echo e($projectdetail['mybid']); ?></font>   
                                    </div>
                                    <hr>  
                                    <div class="rs-make-bid">
                                      <h4>Make New Bid</h4>
