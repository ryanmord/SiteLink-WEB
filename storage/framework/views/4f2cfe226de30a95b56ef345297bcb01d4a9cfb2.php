...
<header class="masthead login sign-up">
	...
	<div class="loader" style="position: fixed;
        ...
        <div class="col-md-4 plans-tab"> 
					<form id="signup-form" action="<?php echo e(url('/storeUserDetail')); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="tab-pane active in fade" id="faq-cat-1">
                <div class="col-md-12 login-right">
                  <div class="form-group">
                    ...
                    <img src="<?php echo e(asset('img/users/default.png')); ?>" id="image" style="height: 100%;width: 100%;">
									</div>
