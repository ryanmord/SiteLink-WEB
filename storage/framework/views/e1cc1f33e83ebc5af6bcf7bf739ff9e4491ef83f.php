      ...
      <div class="container">
        ...
        <div class="intro-text">
          <div class="pdding-left">
            ...
            <form id="login-form" action="<?php echo e(route('checkLogin')); ?>" method="post" role="form" name="login-form">
                ...
                <div class="form-group">
                  <div class="form-group field-loginform2-username">
                    ...
                    <div class="error"><?php echo e($errors->first('login_email')); ?></div>
                    </div>
                  </div>
                  <div class="form-group">
                  <div class="form-group field-loginform2-password">
                    <input type="password" id="login_password" class="form-control" name="login_password" placeholder="Password">
                      <div class="error"><?php echo e($errors->first('login_password')); ?>
                ...
                <div class='forgotemail' style='display:none;'>
                  ...
                  <div class="error"><?php echo e($errors->first('femail')); ?></div>
