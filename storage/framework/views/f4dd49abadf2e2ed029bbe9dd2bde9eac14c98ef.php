          ...
          <div>
            <div>
              <div style=" height: 100px;width: 220px;background-color: #19B5FE;text-align: center;">
                <br>
                <font size="5" color="white"><b><?php echo e($associate); ?></b></font>
                <br>
        ...
        <div>
          <div>
            <div style=" height: 100px;width: 220px;background-color:#26A65B;text-align: center;">
              <br>
              <font size="5" color="white"><b><?php echo e($schedular); ?></b></font>
        ...
        <div>
          <div>
            <div style=" height: 100px;width: 220px;background-color:#DB5A6B;text-align: center;">
                 <br>
                <font size="5" color="white"><b><?php echo e($project); ?></b></font>
            ...
            <div>
              <div style=" height: 100px;width: 220px;background-color:#F5AB35;text-align: center;">
                <br>
                <font size="5" color="white"><b><?php echo e($projectbid); ?></b></font>
    ...
    <?php if(session('loginusertype') == 'admin'): ?>
      <div class="panel panel-success">
        ...
        <div class="content-row">
          <div class="row">
            <div class="panel panel-title">
              <ul id="myTab1" class="nav nav-tabs nav-justified">
               <li class="active"><a href="#schedulingProjects" data-toggle="tab">Project Queue <span class="badge" style="background-color:#DB5A6B;" id="scheduling-Project-Count"><?php echo e($schedulingProjectCount); ?></span>
                </a></li>
                <li><a href="#home1" data-toggle="tab">
                  Unverified Users <span class="badge" style="background-color:#DB5A6B;" id="pending-user-count"><?php echo e($users->count()); ?></span>
                </a></li>
              </ul>
          ...
          <?php echo $__env->make('project.confirmbox', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          <?php if(isset($users) && !empty($users)): ?>
          <?php echo $__env->make('approveuser', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
          <?php endif; ?>
