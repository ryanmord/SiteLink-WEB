              ...
              <div class="row">
                ...
                <ul class="horizontal-tabs nav col-md-10" id="leftTabs">
                  <li id="active-bids" style="margin-left: 180px;">
                    <a href="#active_tab" class="active" data-toggle="tab"> 
                      <img src=<?php echo e(asset('img/front/icon1.png')); ?> alt="" />Active Bids
                    </a>     
                  </li>
                  <li id="history-bids">
                    <a href="#history_tab" data-toggle="tab">
                      <img src=<?php echo e(asset('img/front/icon3.png')); ?> alt="" />Bid History
                    </a>
                  </li>
                </ul>
                <div class="tab-content tab-detail col-md-12">
                  <div class="tab-pane active" id="active_tab">
                    <div class="my-bids">
                      <?php if($activeBidProject['status'] == 1): ?>
                        <div class="row">
                          ...
                          <?php if($activeBidProject['mybids']): ?>
                             <!-- Nav tabs -->
                            <ul class="nav nav-tabs vertical-tabs col-md-3" id="active-projects">
                              ...
                              <div style="overflow-y: scroll;max-height: 430px; background: white;" id="active-project-list"> 
                                <?php $i = 1;?>
                                <?php $__currentLoopData = $activeBidProject['mybids']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <?php if($i == 1): ?>
                                    <li value="<?php echo e($value['projectid']); ?>" id="<?php echo e($value['projectid']); ?>" ><a href="#activeProjectDetail" class ="active odd" data-toggle="tab"><?php echo e($value['projectname']); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    </li>
                                  <?php elseif($i %2 == 0): ?>
                                    <li value="<?php echo e($value['projectid']); ?>" id="<?php echo e($value['projectid']); ?>" ><a href="#history2" class ="even" data-toggle="tab"><?php echo e($value['projectname']); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    </li>
                                  <?php else: ?>
                                    <li value="<?php echo e($value['projectid']); ?>" id="<?php echo e($value['projectid']); ?>" ><a href="#history3" class ="odd" data-toggle="tab"><?php echo e($value['projectname']); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                  <?php endif; ?>
                                  <?php ++$i;?>
                            ...
                            <div id="activeProjectDetail" class="tab-pane active">
                              <div class="project-detail">
                                <div class="ls-project">
                                  <div class="ls-project-address">    
                                    <div class="ls-title">
                                      <h4 id="active-projectname"><?php echo e($activeProjectDetail['projectname']); ?></h4>
                                      <span class="project-date" id="active-createddate"><?php echo e($activeProjectDetail['createddate']); ?></span>
                                      <span class="project-id" id="active-projectid"><?php echo e($activeProjectDetail['projectid']); ?></span>
                                      <input type="hidden" id="active-project-id" name="active-project-id" value="<?php echo e($activeProjectDetail['project_id']); ?>">
                                    </div> 
                                    <hr>
                                  <div class="ls-address">
                                    <div class="address">
                                      ...
                                      <strong id="active-siteaddress">
                                        <?php echo e($activeProjectDetail['siteaddress']); ?></strong>
                                    </div>
                                    <br><br><br>
                                    <div class="report-date" style="float: left;">
                                      <h5><i class="fa fa-calendar" aria-hidden="true"></i>Report Due From Field</h5>
                                      <strong id="active-reportduedate"><?php echo e($activeProjectDetail['reportduedate']); ?></strong>
                                    </div>
                                    <div class="report-date">
                                      <h5><i class="fa fa-calendar" aria-hidden="true"></i>On site Date</h5>
                                      <strong id="active-onsitedate"><?php echo e($activeProjectDetail['onsitedate']); ?></strong>
                                    </div>
                                    <br><br><br>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>Property Type</h5>
                                                          <strong id="active-propertyType"><?php echo e($activeProjectDetail['propertyType']); ?></strong>
                                                      </div>
                                                      <br><br><br>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>No. Units&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>  
                                                          <strong id="active-noOfUnits"><?php echo e($activeProjectDetail['noOfUnits']); ?></strong>

                                                      </div>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>Sq. Footage&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="active-sqFootage"><?php echo e($activeProjectDetail['sqFootage']); ?></strong>
                                                      </div>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>No. Buildings&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="active-noBuildings"><?php echo e($activeProjectDetail['noBuildings']); ?></strong>
                                                      </div>
                                                       <div class="report-date" style="float: left;">
                                                          <h5>Land Area&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="active-landArea"><?php echo e($activeProjectDetail['landArea']); ?></strong>
                                                      </div>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>No. Stories&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="active-noOfStories"><?php echo e($activeProjectDetail['noOfStories']); ?></strong>
                                                      </div>
                                                       <div class="report-date" style="float: left;">
                                                          <h5>Year Built&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="active-yearBuilt"><?php echo e($activeProjectDetail['yearBuilt']); ?></strong>
                                                      </div>
                                  </div>
                                </div>
                                <div class="ls-scope">
                                  <h5>Scope(s)</h5>    
                                  <ul>
                                    <li id="active-scope"><?php echo e($activeProjectDetail['scope']); ?></li>
                                  </ul> 
                                  <hr>   
                                  <h5>Report Template</h5>    
                                  <ul>
                                    <li id="active-template"><?php echo e($activeProjectDetail['template']); ?></li>
                                  </ul>    
                                </div>
                                <div class="ls-instrucation">
                                  <h5>Special Instruction</h5>
                                  <p id="active-instructions"><?php echo e($activeProjectDetail['instructions']); ?>

                                  </p><hr> 
                                  <div class="ls-instructions">
                                  <h5>Suggested Bid</h5>
                                  <p id="active-approxbid" style="font-size: 15px;"><?php echo e($activeProjectDetail['approxbid']); ?></p>  
                                   <h5>Job Reach</h5>
                                  <p id="active-jobReach" style="font-size: 15px;">
                                      <?php echo e($activeProjectDetail['jobReachCount']); ?>&nbsp People
                                  </p>    
                                </div>
                              ...
                              <div class="rs-project">
                               <!--  <div class="rs-suggest-bid">
                                  <h4>Suggested Bid</h4>
                                  <font id="active-approxbid" style="font-size: 15px;"><?php echo e($activeProjectDetail['approxbid']); ?></font>   
                                </div>
                                <div class="rs-suggest-bid">
                                  <h4>Job Reach</h4>
                                ...
                                <hr>  -->
                                <?php if($activeProjectDetail['associateTypeId'] == 1): ?>
                                ...
                                <?php else: ?>
                                 <div class="rs-make-bid">
                                      <h4>Current Bid</h4> <label id="active-bidstatus" style="color: #fe5f55;"><?php echo e($activeProjectDetail['bidstatus']); ?></label>
                                      <label id="active-applydate" style="margin-left: 0px;"><?php echo e($activeProjectDetail['applydate']); ?></label><br>
                                      <font id="active-mybid" style="font-size: 15px;"> <?php echo e($activeProjectDetail['mybid']); ?>
                ...
                <div class="tab-pane" id="history_tab">
                  <div class="my-bids">
                    <?php if($historyBidProject['status'] == 1): ?>
                      <div class="row">
                        ...
                        <?php if($historyBidProject['mybids']): ?>
                          <!-- Nav tabs -->
                          <ul class="nav nav-tabs vertical-tabs col-md-3" id="history-projects">
                            ...
                            <?php $i = 1;?>
                              <?php $__currentLoopData = $historyBidProject['mybids']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($i == 1): ?>
                                  <li value="<?php echo e($value['projectid']); ?>" id="<?php echo e($value['projectid']); ?>" ><a href="#historyProjectDetail" class ="odd active" data-toggle="tab"><?php echo e($value['projectname']); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                  </li>
                                <?php elseif($i %2 == 0): ?>
                                  <li value="<?php echo e($value['projectid']); ?>" id="<?php echo e($value['projectid']); ?>" ><a href="#historyProjectDetail" class ="even" data-toggle="tab"><?php echo e($value['projectname']); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                  </li>
                                <?php else: ?>
                                  <li value="<?php echo e($value['projectid']); ?>" id="<?php echo e($value['projectid']); ?>" ><a href="#historyProjectDetail" class ="odd" data-toggle="tab"><?php echo e($value['projectname']); ?> <i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                                <?php endif; ?>
                                <?php ++$i;?>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                          ...
                          <div id="historyProjectDetail" class="tab-pane active">
                            <div class="project-detail">
                              <div class="ls-project">
                                <div class="ls-project-address">    
                                  <div class="ls-title">
                                    <h4 id="history-projectname"><?php echo e($historyProjectDetail['projectname']); ?></h4>
                                    <span class="project-date" id="history-createddate"><?php echo e($historyProjectDetail['createddate']); ?></span>
                                    <span class="project-id" id="history-projectid"><?php echo e($historyProjectDetail['projectid']); ?></span>
                                    <input type="hidden" id="history-project-id" name="history-projectid" value="<?php echo e($historyProjectDetail['project_id']); ?>">
                                  </div> 
                                  <hr>
                                  <div class="ls-address">
                                    <div class="address">
                                      ...
                                      <strong id="history-siteaddress">
                                        <?php echo e($historyProjectDetail['siteaddress']); ?></strong>
                                      </div>
                                      <br><br><br>
                                      <div class="report-date" style="float: left;">
                                        <h5><i class="fa fa-calendar" aria-hidden="true"></i>Report Due From Field</h5>
                                        <strong id="history-reportduedate"><?php echo e($historyProjectDetail['reportduedate']); ?></strong>
                                      </div>
                                      <div class="report-date">
                                        <h5><i class="fa fa-calendar" aria-hidden="true"></i>On site Date</h5>
                                        <strong id="history-onsitedate"><?php echo e($historyProjectDetail['onsitedate']); ?></strong>
                                      </div>
                                      <br><br><br>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>Property Type</h5>
                                                          <strong id="history-propertyType"><?php echo e($historyProjectDetail['propertyType']); ?></strong>
                                                      </div>
                                                      <br><br><br>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>No. Units&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>  
                                                          <strong id="history-noOfUnits"><?php echo e($historyProjectDetail['noOfUnits']); ?></strong>

                                                      </div>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>Sq. Footage&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="history-sqFootage"><?php echo e($historyProjectDetail['sqFootage']); ?></strong>
                                                      </div>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>No. Buildings&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="history-noBuildings"><?php echo e($historyProjectDetail['noBuildings']); ?></strong>
                                                      </div>
                                                       <div class="report-date" style="float: left;">
                                                          <h5>Land Area&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="history-landArea"><?php echo e($historyProjectDetail['landArea']); ?></strong>
                                                      </div>
                                                      <div class="report-date" style="float: left;">
                                                          <h5>No. Stories&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="history-noOfStories"><?php echo e($historyProjectDetail['noOfStories']); ?></strong>
                                                      </div>
                                                       <div class="report-date" style="float: left;">
                                                          <h5>Year Built&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
                                                          <strong id="history-yearBuilt"><?php echo e($historyProjectDetail['yearBuilt']); ?></strong>
                                                      </div>
                                    </div>
                                  </div>
                                  <div class="ls-scope">
                                    <h5>Scope(s)</h5>    
                                    <ul>
                                      <li id="history-scope"><?php echo e($historyProjectDetail['scope']); ?></li>
                                    </ul> 
                                    <hr>   
                                    <h5>Report Template</h5>    
                                    <ul>
                                      <li id="history-template"><?php echo e($historyProjectDetail['template']); ?></li>
                                    </ul>    
                                  </div>
                                  <div class="ls-instrucation">
                                    <h5>Special Instruction</h5>
                                    <p id="history-instructions"><?php echo e($historyProjectDetail['instructions']); ?>

                                    </p>
                                    <!-- <hr>  -->
                                 <!--  <div class="ls-instructions">
                                  <h5>Suggested Bid</h5>
                                  <p id="history-approxbid" style="font-size: 15px;"><?php echo e($activeProjectDetail['approxbid']); ?></p>  
                                   <h5>Job Reach</h5>
                                ...
                                <div class="rs-project">
                                  <div class="rs-suggest-bid">
                                    <h4>Suggested Bid</h4>
                                    <font id="history-approxbid"><?php echo e($historyProjectDetail['approxbid']); ?></font>   
                                  </div>
                                  <div class="rs-suggest-bid">
                                    <h4>Job Reach</h4>
                                    <font id="jobReach" style="font-size: 15px;">
                                                          <?php echo e($historyProjectDetail['jobReachCount']); ?>&nbsp People</font>   
                                  </div>
                                  <hr> 
                                 <!--  <?php if($historyProjectDetail['associateTypeId'] == 1): ?>
                                    <div class="rs-btn-bid">
                                  ...
                                  <?php else: ?>
                                   <div class="rs-make-bid">
                                      <h4>Current Bid</h4> <label id="history-bidstatus" style="color: #fe5f55;"><?php echo e($historyProjectDetail['bidstatus']); ?></label>
                                      <label id="history-applydate" style="margin-left: 0px;"><?php echo e($historyProjectDetail['applydate']); ?></label><br>
                                      <font id="history-mybid" style="font-size: 15px;"> <?php echo e($historyProjectDetail['mybid']); ?>
