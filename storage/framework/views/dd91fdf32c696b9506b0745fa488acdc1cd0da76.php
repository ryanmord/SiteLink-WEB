...
<head>
    ...
    <link rel="icon" href="<?php echo e(secure_secure_asset('img/front/fav-logo.png')); ?>" type="image/png" sizes="16x16">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <title><?php echo e(config('app.name')); ?></title>
     <link href="<?php echo e(secure_secure_asset('/css/frontCss/front_font.css')); ?>" rel="stylesheet" type="text/css">
  ...
  <link rel="shortcut icon" href="<?php echo e(secure_secure_asset('img/brick-wall.png')); ?>">
...
<body id="page-top">
  <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top " id="mainNav">
      <div class="container">
        <!-- #page-top -->
        <a class="navbar-brand js-scroll-trigger" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(secure_secure_asset('img/front/logo.png')); ?>"></a>
        ...
        <ul class="navbar-nav text-uppercase ml-auto">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="<?php echo e(url('/managerSignup')); ?>">Register
            </a>
          </li>
          <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="<?php echo e(url('/')); ?>">Login</a>
          </li>
          </ul>
        </div>
      </div>
    ...
    <header class="masthead login sign-up">
      <div class="container">
        ...
        height: 100%;
        z-index: 9999;
        background: url('<?php echo e(secure_secure_asset('img/Loader.gif')); ?>') 50% 50% no-repeat rgb(249,249,249);
        opacity: .8;"></div>
            ...
            <div class="col-md-4 plans-tab"> 
              <div class="col-md-4 login-right">
                <h4 class="h4 txtchng">Login here</h4>
                  <form id="login-form" method="POST" action="<?php echo e(url('/login')); ?>" role="form">
                  ...
                  <form id="forgot_password" method="POST" action="<?php echo e(url('/userForgotPassword')); ?>" role="form">
                    <?php echo e(csrf_field()); ?>
