                ...
                <ul class="navbar-nav text-uppercase ml-auto" id="login-menu">
                   ...
                   <!--  <li class="nav-item responsive-1" id="aboutus-menu">
                    ...
                    <li class="nav-item" id="dashboard-menu">
                        <a class="nav-link js-scroll-trigger" href="<?php echo e(route('associateDashboard')); ?>">Home</a>
                    </li>
                    <li class="nav-item" id="projects-menu">
                        <a class="nav-link js-scroll-trigger" href="<?php echo e(url('/home/projects')); ?>">Projects</a>
                    </li>
                    <li class="nav-item" id="myBids-menu">
                        <a class="nav-link js-scroll-trigger" href="<?php echo e(route('jobFinder')); ?>">Job Finder</a>
                    </li>
                    <?php if(session('associateTypeId') != 1): ?>
                    <li class="nav-item" id="bids-menu">
                        <a class="nav-link js-scroll-trigger" href="<?php echo e(route('myBids')); ?>">My Bids</a>
                    </li>
                    <?php endif; ?>
                    ...
                    <li class="nav-item" id="myProfile-menu">
                        <a class="nav-link js-scroll-trigger" href="<?php echo e(url('/home/myProfile')); ?>"><?php echo e(ucfirst(session('associateName'))); ?><img src="<?php echo e(asset('img/users/'.session('profileImage'))); ?>"></a>
                        
                    </li>
                    <li class="nav-item">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="<?php echo e(url('/home/logout')); ?>">  Logout</a>
                    </li>
