...
<!-- Navigation -->
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top " id="mainNav">
        <div class="container">
            <!-- #page-top -->
            <a class="navbar-brand js-scroll-trigger" href="#"><img src="<?php echo e(asset('img/front/logo.png')); ?>"></a>
            ...
            <div class="intro-text">
                ...
                <?php if($flag == 0): ?>
                    ...
                    <div class="col-md-4 login-right">
                        ...
                        <form id="resetpassword-form" method="POST" action="<?php echo e(url('/changepassword')); ?>" role="form">
